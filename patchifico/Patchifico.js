...
// include: /var/folders/3h/tg402mjj2clchq8mcmw9mtwc0000gn/T/tmpnsu5lb4h.js
...
// end include: /var/folders/3h/tg402mjj2clchq8mcmw9mtwc0000gn/T/tmpnsu5lb4h.js
// include: /var/folders/3h/tg402mjj2clchq8mcmw9mtwc0000gn/T/tmp4oyggo1o.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/3h/tg402mjj2clchq8mcmw9mtwc0000gn/T/tmp4oyggo1o.js
// include: /var/folders/3h/tg402mjj2clchq8mcmw9mtwc0000gn/T/tmpzsrjbgnf.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/3h/tg402mjj2clchq8mcmw9mtwc0000gn/T/tmpzsrjbgnf.js
...
var ASM_CONSTS = {
 ...
 53679: ($0) => { miniaudio.untrack_device_by_index($0); },  
 53722: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 53847: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; },  
 53973: () => { if (document.fullscreenElement) return 1; },  
 54019: () => { return Module.canvas.width; },  
 54051: () => { return parseInt(Module.canvas.style.width); },  
 54099: () => { document.exitFullscreen(); },  
 54126: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 54199: () => { if (document.fullscreenElement) return 1; },  
 54245: () => { return Module.canvas.width; },  
 54277: () => { return screen.width; },  
 54302: () => { document.exitFullscreen(); },  
 54329: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 54462: () => { return window.innerWidth; },  
 54488: () => { return window.innerHeight; },  
 54515: () => { if (document.fullscreenElement) return 1; },  
 54561: () => { return Module.canvas.width; },  
 54593: () => { return parseInt(Module.canvas.style.width); },  
 54641: () => { if (document.fullscreenElement) return 1; },  
 54687: () => { return Module.canvas.width; },  
 54719: () => { return screen.width; },  
 54744: () => { return window.innerWidth; },  
 54770: () => { return window.innerHeight; },  
 54797: () => { if (document.fullscreenElement) return 1; },  
 54843: () => { return Module.canvas.width; },  
 54875: () => { return screen.width; },  
 54900: () => { document.exitFullscreen(); },  
 54927: () => { if (document.fullscreenElement) return 1; },  
 54973: () => { return Module.canvas.width; },  
 55005: () => { return parseInt(Module.canvas.style.width); },  
 55053: () => { document.exitFullscreen(); },  
 55080: ($0) => { Module.canvas.style.opacity = $0; },  
 55118: () => { return screen.width; },  
 55143: () => { return screen.height; },  
 55169: () => { return window.screenX; },  
 55196: () => { return window.screenY; },  
 55223: () => { return window.devicePixelRatio; },  
 55259: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 55312: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 55363: () => { Module.canvas.style.cursor = 'none'; },  
 55400: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 55656: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 55707: () => { if (document.pointerLockElement) return 1; },  
 55754: () => { if (document.fullscreenElement) return 1; },  
 55800: () => { return window.innerWidth; },  
 55826: () => { return window.innerHeight; }
};
